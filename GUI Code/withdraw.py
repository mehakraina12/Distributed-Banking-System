...
class withdraw:
    def __init__(self,root):
        ...
        Frame_login.place(x=300,y=150,height=450,width=840)

        title=Label(Frame_login,text="Welcome to the Withdrawal Page!",font=("Impact",35,"bold"),fg="sea green",bg="white").place(x=90,y=30)
